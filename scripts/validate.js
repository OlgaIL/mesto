...
function initValidation ({formSelector, inputSelector, submitSelector, disableSubmitClass, inputErrorClass}) {
	const formSelectElement = document.querySelector(formSelector);
	...
	inputList.forEach((inputElement) => {
		...
		isValid(formSelectElement, inputElement, inputErrorClass);
		toggleButtonState(inputList, buttonSubmit, disableSubmitClass);
		});
	});
